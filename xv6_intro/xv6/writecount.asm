...
int main(int argc, char**argv) {
  ...
  10:	e8 1f 01 00 00       	call   134 <setwritecount>
    printf(1, "test\n");
  ...
  24:	e8 b3 01 00 00       	call   1dc <printf>
    ...
    wc = writecount();
  29:	e8 fe 00 00 00       	call   12c <writecount>
    printf(1, "writecount: %d\n", wc);
  2e:	89 44 24 08          	mov    %eax,0x8(%esp)
  32:	c7 44 24 04 3b 03 00 	movl   $0x33b,0x4(%esp)
  39:	00 
  3a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  41:	e8 96 01 00 00       	call   1dc <printf>
    
    setwritecount(50);
  46:	c7 04 24 32 00 00 00 	movl   $0x32,(%esp)
  4d:	e8 e2 00 00 00       	call   134 <setwritecount>
    wc = writecount();
  52:	e8 d5 00 00 00       	call   12c <writecount>
    printf(1, "writecount: %d\n", wc);
  57:	89 44 24 08          	mov    %eax,0x8(%esp)
  5b:	c7 44 24 04 3b 03 00 	movl   $0x33b,0x4(%esp)
  62:	00 
  63:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  6a:	e8 6d 01 00 00       	call   1dc <printf>

    exit();
  6f:	e8 08 00 00 00       	call   7c <exit>
...
0000007c <exit>:
SYSCALL(exit)
  7c:	b8 02 00 00 00       	mov    $0x2,%eax
  81:	cd 40                	int    $0x40
  83:	c3                   	ret    

00000084 <wait>:
SYSCALL(wait)
  84:	b8 03 00 00 00       	mov    $0x3,%eax
  89:	cd 40                	int    $0x40
  8b:	c3                   	ret    
...
000000a4 <close>:
SYSCALL(close)
  a4:	b8 15 00 00 00       	mov    $0x15,%eax
  a9:	cd 40                	int    $0x40
  ab:	c3                   	ret    
...
000000b4 <exec>:
SYSCALL(exec)
  b4:	b8 07 00 00 00       	mov    $0x7,%eax
  b9:	cd 40                	int    $0x40
  bb:	c3                   	ret    

000000bc <open>:
SYSCALL(open)
  bc:	b8 0f 00 00 00       	mov    $0xf,%eax
  c1:	cd 40                	int    $0x40
  c3:	c3                   	ret    

000000c4 <mknod>:
SYSCALL(mknod)
  c4:	b8 11 00 00 00       	mov    $0x11,%eax
  c9:	cd 40                	int    $0x40
  cb:	c3                   	ret    

000000cc <unlink>:
SYSCALL(unlink)
  cc:	b8 12 00 00 00       	mov    $0x12,%eax
  d1:	cd 40                	int    $0x40
  d3:	c3                   	ret    

000000d4 <fstat>:
SYSCALL(fstat)
  d4:	b8 08 00 00 00       	mov    $0x8,%eax
  d9:	cd 40                	int    $0x40
  db:	c3                   	ret    
...
000000e4 <mkdir>:
SYSCALL(mkdir)
  e4:	b8 14 00 00 00       	mov    $0x14,%eax
  e9:	cd 40                	int    $0x40
  eb:	c3                   	ret    

000000ec <chdir>:
SYSCALL(chdir)
  ec:	b8 09 00 00 00       	mov    $0x9,%eax
  f1:	cd 40                	int    $0x40
  f3:	c3                   	ret    

000000f4 <dup>:
SYSCALL(dup)
  f4:	b8 0a 00 00 00       	mov    $0xa,%eax
  f9:	cd 40                	int    $0x40
  fb:	c3                   	ret    

000000fc <getpid>:
SYSCALL(getpid)
  fc:	b8 0b 00 00 00       	mov    $0xb,%eax
 101:	cd 40                	int    $0x40
 103:	c3                   	ret    

00000104 <sbrk>:
SYSCALL(sbrk)
 104:	b8 0c 00 00 00       	mov    $0xc,%eax
 109:	cd 40                	int    $0x40
 10b:	c3                   	ret    

0000010c <sleep>:
SYSCALL(sleep)
 10c:	b8 0d 00 00 00       	mov    $0xd,%eax
 111:	cd 40                	int    $0x40
 113:	c3                   	ret    

00000114 <uptime>:
SYSCALL(uptime)
 114:	b8 0e 00 00 00       	mov    $0xe,%eax
 119:	cd 40                	int    $0x40
 11b:	c3                   	ret    

0000011c <yield>:
SYSCALL(yield)
 11c:	b8 16 00 00 00       	mov    $0x16,%eax
 121:	cd 40                	int    $0x40
 123:	c3                   	ret    
...
0000012c <writecount>:
SYSCALL(writecount)
 12c:	b8 18 00 00 00       	mov    $0x18,%eax
 131:	cd 40                	int    $0x40
 133:	c3                   	ret    

00000134 <setwritecount>:
SYSCALL(setwritecount)
 134:	b8 19 00 00 00       	mov    $0x19,%eax
 139:	cd 40                	int    $0x40
 13b:	c3                   	ret    
...
putc(int fd, char c)
{
 ...
 15b:	e8 3c ff ff ff       	call   9c <write>
}
 160:	c9                   	leave  
 161:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 19e:	f7 f1                	div    %ecx
 1a0:	0f b6 92 52 03 00 00 	movzbl 0x352(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 295:	75 19                	jne    2b0 <printf+0xd4>
          s = "(null)";
 297:	bb 4b 03 00 00       	mov    $0x34b,%ebx
